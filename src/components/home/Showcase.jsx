  ...
  return (
    <section className="relative overflow-hidden border-b border-[color:color-mix(in_srgb,var(--text-primary)_10%,transparent)] bg-[var(--bg-main)] text-[var(--text-primary)] -mt-12">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-6 pb-0 pt-8 lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:px-8 lg:pt-10">
        <div className="max-w-2xl pb-6 lg:pb-12 pt-6 sm:pt-16">
          <div className="inline-flex items-center gap-2 rounded-full border border-[color:var(--border-color)] bg-[color:color-mix(in_srgb,var(--card-bg)_90%,transparent)] px-3 py-1.5 lg:px-4 lg:py-2 text-xs lg:text-sm font-medium tracking-[0.24em] text-[color:color-mix(in_srgb,var(--text-secondary)_88%,transparent)] uppercase shadow-[0_14px_40px_rgba(0,0,0,0.18)] backdrop-blur-xl">
            Elevated Everyday Tech
          </div>

          <h1 className="mt-5 lg:mt-7 max-w-xl text-3xl sm:text-4xl lg:text-6xl leading-[0.95] font-extrabold tracking-[-0.04em] text-transparent bg-[linear-gradient(135deg,var(--text-primary),color-mix(in_srgb,var(--text-primary)_58%,transparent))] bg-clip-text">
            Discover Your Next Favorite Tech.
          </h1>

          <p className="mt-4 lg:mt-6 max-w-xl text-sm sm:text-base lg:text-lg leading-7 lg:leading-8 text-[var(--text-secondary)]">
            Explore premium gadgets with modern design and powerful performance.
          </p>

          <div className="mt-6 lg:mt-9 flex flex-col gap-4 sm:flex-row">
            <button className="rounded-full bg-[linear-gradient(135deg,#d8a772,#9b623a)] px-6 py-3 lg:px-7 lg:py-3.5 text-sm font-semibold tracking-[0.18em] text-white uppercase shadow-[0_18px_40px_rgba(169,116,79,0.38)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_22px_50px_rgba(169,116,79,0.5)]">
              Shop Now
            </button>
          </div>
        </div>
        ...
        {/* right */}
        <div className="hidden lg:flex relative items-end justify-center self-end lg:justify-end">
